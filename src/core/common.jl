...
encrypt(key::AbstractAesKey, a::T) where {T} = from_uint128(T, encrypt(key, to_uint128(a)))
decrypt(key::AbstractAesKey, a::T) where {T} = from_uint128(T, decrypt(key, to_uint128(a)))
